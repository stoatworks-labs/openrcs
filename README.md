...
**[v0.8.1](https://github.com/stoatworks-labs/openrcs/releases/tag/v0.8.1)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image (CLI) | [`openrcs-server-0.8.1-macos-universal-cli.dmg`](https://github.com/stoatworks-labs/openrcs/releases/download/v0.8.1/openrcs-server-0.8.1-macos-universal-cli.dmg) | 3.2 MB |
| .dmg disk image (app) | [`openrcs-0.8.1-macos-app.dmg`](https://github.com/stoatworks-labs/openrcs/releases/download/v0.8.1/openrcs-0.8.1-macos-app.dmg) | 12 MB |
| Universal (Apple Silicon + Intel) · .pkg installer (CLI) | [`openrcs-server-0.8.1-macos-universal-cli.pkg`](https://github.com/stoatworks-labs/openrcs/releases/download/v0.8.1/openrcs-server-0.8.1-macos-universal-cli.pkg) | 2.7 MB |
| .pkg installer (app) | [`openrcs-0.8.1-macos-app.pkg`](https://github.com/stoatworks-labs/openrcs/releases/download/v0.8.1/openrcs-0.8.1-macos-app.pkg) | 11 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`openrcs-server-0.8.1-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/openrcs/releases/download/v0.8.1/openrcs-server-0.8.1-windows-x86_64-setup.exe) | 1.0 MB |
| x64 · .exe installer | [`openRCS_0.8.1_x64-setup.exe`](https://github.com/stoatworks-labs/openrcs/releases/download/v0.8.1/openRCS_0.8.1_x64-setup.exe) | 3.3 MB |
| ARM64 · .exe installer | [`openrcs-server-0.8.1-windows-aarch64-setup.exe`](https://github.com/stoatworks-labs/openrcs/releases/download/v0.8.1/openrcs-server-0.8.1-windows-aarch64-setup.exe) | 930 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .deb package (Debian/Ubuntu) | [`openrcs-server_0.8.1_amd64.deb`](https://github.com/stoatworks-labs/openrcs/releases/download/v0.8.1/openrcs-server_0.8.1_amd64.deb) | 1.5 MB |
| x64 · .deb package (Debian/Ubuntu) | [`openRCS_0.8.1_amd64.deb`](https://github.com/stoatworks-labs/openrcs/releases/download/v0.8.1/openRCS_0.8.1_amd64.deb) | 6.8 MB |
| ARM64 · .deb package (Debian/Ubuntu) | [`openrcs-server_0.8.1_arm64.deb`](https://github.com/stoatworks-labs/openrcs/releases/download/v0.8.1/openrcs-server_0.8.1_arm64.deb) | 1.6 MB |
| x64 · .rpm package (Fedora/RHEL) | [`openRCS-0.8.1-1.x86_64.rpm`](https://github.com/stoatworks-labs/openrcs/releases/download/v0.8.1/openRCS-0.8.1-1.x86_64.rpm) | 6.8 MB |
| x64 · .rpm package (Fedora/RHEL) | [`openrcs-server-0.8.1-1.x86_64.rpm`](https://github.com/stoatworks-labs/openrcs/releases/download/v0.8.1/openrcs-server-0.8.1-1.x86_64.rpm) | 1.6 MB |
| ARM64 · .rpm package (Fedora/RHEL) | [`openrcs-server-0.8.1-1.aarch64.rpm`](https://github.com/stoatworks-labs/openrcs/releases/download/v0.8.1/openrcs-server-0.8.1-1.aarch64.rpm) | 1.6 MB |
